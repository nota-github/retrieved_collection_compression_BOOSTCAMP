...
class Options:
    ...
    def add_model_options(self):
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="SpanBERT/spanbert-base-cased",
    ...
    def add_index_options(self):
        ...
        self.parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="dump only first passages",
        )
        self.parser.add_argument(
            "--index_filter",
            type=float,
            default=-1e8,
            help="filtering threshold for index",
        )
        ...
        self.parser.add_argument(
            "--subindex_name",
            default="index",
            help="used only if dump_path is specified.",
        )
    ...
    def add_data_options(self):
        ...
        self.parser.add_argument(
            "--truecase",
            action="store_true",
            help="Dummy (automatic truecasing supported)",
        )
    ...
    def add_rc_options(self):
        ...
        self.parser.add_argument(
            "--append_title",
            action="store_true",
            help="Whether to append title in context.",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--wandb",
            action="store_true",
            help="Whether to use Weights and Biases logging",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--filter_only",
            action="store_true",
            help="Whether to generate filter logits only",
        )
    ...
    def parse(self):
        ...
        if hasattr(opt, "output_dir") and hasattr(opt, "do_train"):
            if (
                os.path.exists(opt.output_dir)
                and os.listdir(opt.output_dir)
                and opt.do_train
